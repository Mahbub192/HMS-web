...
export default function IPDServicePage() {
  return (
        ...
        <div className="flex-1 p-8 overflow-y-auto">
          <div className="w-full max-w-7xl mx-auto">
            ...
            <p className="text-[#61897c] dark:text-gray-400 text-base font-normal leading-normal mb-8">
              Inpatient Department services and management.
            </p>
            <div className="bg-white dark:bg-[#182c25] rounded-xl border border-[#dbe6e2] dark:border-[#2a3f38] p-8 text-center">
              ...
              <p className="text-[#61897c] dark:text-gray-400">
                IPD Service overview page. Use the sidebar to navigate to specific IPD services.
              </p>
            </div>
          </div>
        </div>
